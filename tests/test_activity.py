...
class TestActivity:
    ...
    def test_get_time_series_normal(self, sample_activity: Activity) -> None:
        series = sample_activity.get_time_series("power", 10, 20)
        assert len(series) == 10
        assert isinstance(series, np.ndarray)

    def test_get_time_series_full_range(self, sample_activity: Activity) -> None:
        series = sample_activity.get_time_series("power")
        assert len(series) == len(sample_activity.data)

    def test_get_time_series_invalid_indices(self, sample_activity: Activity) -> None:
        # Negative start
    ...
    def test_get_time_series_missing_column(self, sample_activity: Activity) -> None:
        series = sample_activity.get_time_series("nonexistent")
        assert len(series) == 0

    def test_get_time_array(self, sample_activity: Activity) -> None:
    ...
    def test_get_time_array_empty(self, empty_activity: Activity) -> None:
        time_array = empty_activity.get_time_array()
        assert len(time_array) == 0

    def test_available_metrics(self, sample_activity: Activity) -> None:
    ...
    def test_get_data_range(self, sample_activity: Activity) -> None:
